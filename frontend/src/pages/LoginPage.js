  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12 bg-[#FFFDF7]">
      <div className="w-full max-w-md">
        ...
        <div className="bold-card p-8" data-testid="login-form-container">
          {error && (
          ...
          <div className="mt-4">
            <button onClick={handleGuest} disabled={guestLoading} data-testid="guest-login-btn"
              className="w-full bold-btn bold-btn-ghost py-3 text-sm">
              {guestLoading ? "Setting up..." : "Continue without account"}
            </button>
          </div>
